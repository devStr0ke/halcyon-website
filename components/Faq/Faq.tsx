...
export const Faq = ({ title, text, ...props }: Props) => {
  ...
  const heightClassController = () => {
    if (hamburgerController) {
      ...
      return 'h-[65px] z-10 bg-white relative w-full rounded-lg transition-productCard duration-500';
  };
    ...
    return (
      <>
        <div
          onClick={toggleClass}
          ref={element}
          className="top-0 bg-transparent w-full relative z-10 saira md:px-4 lg:px-24 xl:px-36 opacity-0 cursor-pointer"
        >
