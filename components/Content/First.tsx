...
export const First = () => {
  ...
  return (
    <>
      <div className="relative h-[388vh] w-full">
        <div
        ...
        <div className="relative">
          <OverviewCardLeft
            ...
            backImageClass="bg-no-repeat bg-left bg-cover bg-[url('/static/images/HeroLab.png')] lg:rounded-lg w-full"
          />
        </div>
        ...
        <div className="relative pt-52">
          <OverviewCardLeft
            ...
            backImageClass="bg-no-repeat bg-center sm:bg-left bg-cover bg-[url('/static/images/HeroWarp.jpg')] lg:rounded-lg w-full"
          />
        </div>
      </div>
    </>
